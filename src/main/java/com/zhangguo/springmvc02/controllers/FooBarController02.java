...
public class FooBarController02 {
	...
	public String action3(@PathVariable int p1, @PathVariable int p2,
			Model model) {
	...
	public String action5(Model model, @PathVariable String name, // 路径变量，用于获得路径中的变量name的值
			@MatrixVariable String r, @MatrixVariable(required = true) String g, // 参数g是必须的
